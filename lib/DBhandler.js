...
/*
 * get statistics about the participant's gender
 */
exports.getCountsGender = function(year, callback) {
  const queries = {
    male:   'SELECT COUNT(*) AS count FROM users WHERE year=? AND gender=\'male\';',
    female: 'SELECT COUNT(*) AS count FROM users WHERE year=? AND gender=\'female\';',
    other:  'SELECT COUNT(*) AS count FROM users WHERE year=? AND gender=\'other\';'
  };
...
/*
 * get statistics about the participant's study program
 */
exports.getCountsStudy = function(year, callback) {
  const queries = {
    Geo:  'SELECT COUNT(*) AS count FROM users WHERE year=? AND study=\'Geographie\';',
    Loek: 'SELECT COUNT(*) AS count FROM users WHERE year=? AND study=\'Landschaftsökologie\';',
    GI:   'SELECT COUNT(*) AS count FROM users WHERE year=? AND study=\'Geoinformatik\';',
    ZFB:  'SELECT COUNT(*) AS count FROM users WHERE year=? AND study=\'Zwei-Fach-Bachelor\';'
  };
...
/*
 * get statistics about the participant's food preferences
 */
exports.getCountsFood = function(year, callback) {
  const queries = {
    fleischig:   'SELECT COUNT(*) AS count FROM users WHERE year=? AND food=\'fleischig\';',
    vegetarisch: 'SELECT COUNT(*) AS count FROM users WHERE year=? AND food=\'vegetarisch\';',
    vegan:       'SELECT COUNT(*) AS count FROM users WHERE year=? AND food=\'vegan\';'
  };
